...
<script> /* a script for capitalizing first letters of words - will be using in input validating */
	...
	function fixTurkishChars(str) {
		var letters = { "ý": "i", "þ": "s", "ð": "g", "ü": "u", "ö": "o", "ç": "c", "Ý": "I", "Þ": "S", "Ð": "G", "Ü": "U", "Ö": "O", "Ç": "C" };
		return str.replace(/(([ýþðüöçÝÞÐÜÖÇ]))/g, function(letter){ return letters[letter]; })
	}
</script>
<head>
...
<link rel="stylesheet" href="css/style.css">
	...
	<div class="navigator"> 
		<div class="dropdown">
		  <button class="homebtn"><a href="user.php"><img src="images/home-icon.png" style="max-height: 22px; -webkit-transform: translate(-60%, -68%); position: absolute;"></a></button>
		</div>
		<div class="dropdown">
		  <button class="dropbtn"><a href="user_book.php">VIEW MY BOOKS</a></button>
		</div>
		<div class="dropdown">
		  <button class="dropbtn"><a href="books_page.php">LIST ALL BOOKS</a></button>
		</div>
	</div>
	<div class="search_box">
		<form style="float:right; padding-top: 8px; padding-right: 50px;" action="books_page.php" method="POST"> 
