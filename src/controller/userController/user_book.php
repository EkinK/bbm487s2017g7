	...
	<div class="top">
		...
		<div class="animated fadeInRight" style = "-webkit-animation-duration: 0.5s; -webkit-animation-delay: 0.5;">
			<div class="box-header">
				<h2 style="letter-spacing: 0px; font-size: 1.3em; padding-left: 5px;">YOUR BOOKS</h2>
			</div>
			<table class="tbl" style="border-radius: 8px;">
				<?php 
					listUserBooks($_SESSION["userID"]);
				?>
			</table>
		</div>
	</div>
...
<div class="container" style="padding-left: 15px;">
	<div class="top">
		...
		<div class="animated fadeInLeft" style = "-webkit-animation-duration: 0.5s; -webkit-animation-delay: 0.5;">
			<div class="box-header">
				<h2 style="letter-spacing: 0px; font-size: 1.3em; padding-left: 5px;">YOUR WAITINGS</h2>
			</div>
			<table class="tbl" style="border-radius: 8px;">
				<?php 
					listUserWaitings($_SESSION["userID"]);
				?>
			</table>
		</div>
	</div>
